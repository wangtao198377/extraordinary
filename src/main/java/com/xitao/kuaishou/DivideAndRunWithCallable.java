...
public class DivideAndRunWithCallable {
    private List<Integer> target;
    private Integer threadNum;
    //private CountDownLatch latch;

    DivideAndRunWithCallable(List<Integer> target, Integer threadNum) {
        this.target=target;
    ...
    public Integer sumValue() throws Exception {
        ...
        for(int i=0;i<result.size();i++) {
            ...
            Future<Integer> future = executorService.submit(divideClass);
            futures.add(future);
    ...
    public static void main(String[] args) throws Exception {
        ...
        DivideAndRunWithCallable divideAndRunByMultiThread = new DivideAndRunWithCallable(ls,10);
