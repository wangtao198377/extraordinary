...
public class DivideAndRunByMultiThreadWithFuture {
    private List<Integer> target;
    private Integer threadNum;
    //private CountDownLatch latch;

    DivideAndRunByMultiThreadWithFuture(List<Integer> target, Integer threadNum) {
        this.target=target;
    ...
    public static void main(String[] args) throws Exception {
        ...
        DivideAndRunByMultiThreadWithFuture divideAndRunByMultiThread = new DivideAndRunByMultiThreadWithFuture(ls,10);
