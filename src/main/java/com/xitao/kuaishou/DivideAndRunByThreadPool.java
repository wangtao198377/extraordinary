...
public class DivideAndRunByThreadPool {
    private List<Integer> target;
    private Integer threadNum;
    private CountDownLatch latch;

    DivideAndRunByThreadPool(List<Integer> target, Integer threadNum) {
        this.target=target;
    ...
    public Integer sumValue() throws Exception {
        ...
        for(int i=0;i<result.size();i++) {
            ...
            executorService.execute(divideClass);
        }
        latch.await();
        Integer resultSum = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        DivideAndRunByThreadPool divideAndRunByMultiThread = new DivideAndRunByThreadPool(ls,10);
